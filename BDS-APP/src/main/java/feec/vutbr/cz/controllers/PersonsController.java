...
public class PersonsController {
    ...
    @FXML
    private TableColumn<PersonBasicView, String> personsMiddlename;
    @FXML
...
//        GlyphsDude.setIcon(exitMenuItem, FontAwesomeIcon.CLOSE, "1em");
        ...
        personsMiddlename.setCellValueFactory(new PropertyValueFactory<PersonBasicView, String>("middleName"));
    ...
    private void initializeTableViewSelection() {
        ...
        detailedView.setOnAction((ActionEvent event) -> {
            ...
            try {
                ...
                Integer personId = personView.getId();
